...
class Init
{
    ...
    */
    public function loginLogo()
    {
        ?>
          <style>
            ...
            background-image: url( <?=(KCMS_BRANDING_PLUGIN_URL . 'assets/images/logo-icon.svg')?> );
    ...
    public function createMenu()
    {
        ...
        $wp_admin_bar->add_node([
          'id' => $menu_id,
          'title' =>
          '<span class="ab-icon">' . file_get_contents(KCMS_BRANDING_PLUGIN_DIR . "assets/images/logo-icon.svg") . '</span>',
          'href' => '/'
        ]);
        $wp_admin_bar->add_node([
          'parent' => $menu_id,
        ...
        ?>
          <style>
            ...
            .components-button.edit-post-fullscreen-mode-close.has-icon::after {
              content: url( <?=KCMS_BRANDING_PLUGIN_URL . 'assets/images/logo-icon-white.svg' ?> );
              width: 50px;
              height: 35px;
            }
    ...
    */
    ...
    {
        return 'Site powered by <a href="https://kubee.ga">KCMS</a>';
    }
}
